                ...
                <div>
                  <div class="control"> 
                    ...
                    <br/>
                      ...
                      <button v-on:click.prevent="validate" style="border-radius: 50px; padding-left: 30px; padding-right: 30px; font-size: 20px;" type="button" class="btn btn-info" @click="CheckLogin(newAdmin)">
                        Login
                      </button>
                  </div>
